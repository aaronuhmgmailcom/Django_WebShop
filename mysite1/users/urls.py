...
urlpatterns = [
    ...
    # http://47.94.174.118:8000/v1/users/sms
    path('sms', views.sms_view),
    # http://47.94.174.118:8000/v1/users/about
    path("user_about", views.about_view),
    # http://47.94.174.118:8000/v1/users/balance
    path("balance",views.balance_view),
    # http://47.94.174.118:8000/v1/users/tedu
    path('<str:username>', views.UsersView.as_view()),
    # http://47.94.174.118:8000/v1/users/tedu/avatar
